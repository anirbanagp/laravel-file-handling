...
<head>
  ...
  <title>WGTCRM - Installation</title>
  ...
  <style>
    ...
    <body>
      ...
      <div class="row">
       ...
       <div class="col-md-8 col-md-offset-2">
        ...
        <div class="form-group">
          <label for="hostname" class="control-label">Foldername</label>
          <input type="text" class="form-control" name="foldername" value="tenant">
        </div>
        <div class="form-group">
     ...
     <?php echo '<input type="hidden" name="foldername" value="'.$_POST['foldername'].'">'; ?>
