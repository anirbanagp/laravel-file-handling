...
(15, 'clients_default_theme', 'wgt', 1),
(16, 'company_logo', '', 1),
...
--
-- Table structure for table `tblallmodulesname`
--

CREATE TABLE `tblallmodulesname` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `tblallmodulesname`
--

INSERT INTO `tblallmodulesname` (`id`, `parent_id`, `module`, `uri`, `status`) VALUES
(1, NULL, 'set-up-menu-staff', 'staff', 1),
(2, 26, 'set-up-menu-customers', 'clients', 1),
(3, 39, 'set-up-menu/tickets/departments', 'departments', 0),
(4, 39, 'set-up-menu/tickets/predefined-replies', 'tickets/predefined_replies', 0),
(5, 39, 'set-up-menu/tickets/ticket-priority', 'tickets/priorities', 0),
(6, 39, 'set-up-menu/tickets/ticket-statuses', 'tickets/statuses', 0),
(7, 39, 'set-up-menu/tickets/services', 'tickets/services', 0),
(8, 39, 'set-up-menu/tickets/spam-filters', 'tickets/spam_filters', 0),
(11, 40, 'set-up-menu-leads', 'leads', 1),
(12, 40, 'set-up-menu/leads/web-to-lead', 'leads/forms', 1),
(13, NULL, 'set-up-menu-finance', '#', 1),
(14, NULL, 'set-up-menu-contracts', 'contracts', 1),
(15, NULL, 'set-up-menu-email-templates', 'emails', 1),
(16, NULL, 'set-up-menu-custom-fields', 'custom_fields', 1),
(17, NULL, 'set-up-menu-gdpr', 'gdpr', 1),
(18, NULL, 'set-up-menu-roles', 'roles', 1),
(19, NULL, 'set-up-menu-menu-builder', '#', 0),
(20, 19, 'set-up-menu/menu-builder/organize-sidebar', 'utilities/main_menu', 0),
(21, 19, 'set-up-menu/menu-builder/setup-menu', 'utilities/setup_menu', 0),
(22, NULL, 'set-up-menu-theme-style', 'utilities/theme_style', 0),
(23, NULL, 'set-up-menu-settings', 'settings', 1),
(24, NULL, 'set-up-menu-setup-help', '#', 0),
(25, NULL, 'aside-menu-dashboard', '/', 1),
(26, NULL, 'aside-menu-customers', 'clients', 1),
(27, NULL, 'aside-menu-sales', 'sales', 1),
(28, 27, 'aside-menu/sales/child-proposals', 'proposals', 1),
(29, 27, 'aside-menu/sales/child-estimates', 'estimates/list_estimates', 1),
(30, 27, 'aside-menu/sales/child-invoices', 'invoices/list_invoices', 1),
(31, 27, 'aside-menu/sales/child-payments', 'payments', 1),
(32, 27, 'aside-menu/sales/credit_notes', 'credit_notes', 1),
(33, 27, 'aside-menu/sales/child-items', 'invoice_items', 1),
(34, NULL, 'aside-menu-subscriptions', 'subscriptions', 1),
(35, NULL, 'aside-menu-expenses', 'expenses/list_expenses', 1),
(36, NULL, 'aside-menu-contracts', 'contracts', 1),
(37, NULL, 'aside-menu-projects', 'projects', 1),
(38, NULL, 'aside-menu-tasks', 'tasks/list_tasks', 1),
(39, NULL, 'aside-menu-tickets', 'tickets', 0),
(40, NULL, 'aside-menu-leads', 'leads', 1),
(41, NULL, 'aside-menu-knowledge-base', 'knowledge_base', 0),
(42, NULL, 'aside-menu-utilities', 'utilities', 1),
(43, 42, 'aside-menu/utilities/child-media', 'utilities/media', 1),
(44, 42, 'aside-menu/utilities/child-bulk-pdf-exporter', 'utilities/bulk_pdf_exporter', 0),
(45, 42, 'aside-menu/utilities/child-calendar', 'utilities/calendar', 1),
(46, 42, 'aside-menu/utilities/child-goals-tracking', 'goals', 1),
(47, 42, 'aside-menu/utilities/child-surveys', 'surveys', 0),
(48, 42, 'aside-menu/utilities/child-announcements', 'announcements', 1),
(49, 42, 'aside-menu/utilities/child-database-backup', 'utilities/backup', 0),
(50, 42, 'aside-menu/utilities/child-activity-log', 'utilities/activity_log', 0),
(51, 42, 'aside-menu/utilities/ticket-pipe-log', 'utilities/pipe_log', 1),
(52, NULL, 'aside-menu-reports', 'reports', 1),
(53, 52, 'aside-menu/reports/child-sales', 'reports/sales', 1),
(54, 52, 'aside-menu/reports/child-expenses', 'reports/expenses', 1),
(55, 52, 'aside-menu/reports/child-expenses-vs-income', 'reports/expenses_vs_income', 1),
(56, 52, 'aside-menu/reports/child-leads', 'reports/leads', 1),
(57, 52, 'aside-menu/reports/reports_timesheets_overview', 'staff/timesheets&view=all', 1),
(58, 52, 'aside-menu/reports/child-kb-articles', 'reports/knowledge_base_articles', 0),
(59, NULL, 'settings-page-general', 'settings&group=general', 1),
(60, NULL, 'settings-page-company', 'settings&group=company', 1),
(61, NULL, 'settings-page-localization', 'settings&group=localization', 1),
(62, 15, 'settings-page-email', 'settings&group=email', 1),
(63, 27, 'settings-page-sales', 'settings&group=sales', 1),
(64, 34, 'settings-page-subscriptions', 'settings&group=subscriptions', 1),
(65, NULL, 'settings-page-online_payment_modes', 'settings&group=online_payment_modes', 0),
(66, 26, 'settings-page-clients', 'settings&group=clients', 1),
(67, NULL, 'settings-page-tasks', 'settings&group=tasks', 1),
(68, 39, 'settings-page-tickets', 'settings&group=tickets', 0),
(69, 40, 'settings-page-leads', 'settings&group=leads', 1),
(70, NULL, 'settings-page-calendar', 'settings&group=calendar', 1),
(71, NULL, 'settings-page-pdf', 'settings&group=pdf', 1),
(72, NULL, 'settings-page-e_sign', 'settings&group=e_sign', 1),
(73, NULL, 'settings-page-sms', 'settings&group=sms', 0),
(74, NULL, 'settings-page-cronjob', 'settings&group=cronjob', 0),
(75, NULL, 'settings-page-tags', 'settings&group=tags', 1),
(76, NULL, 'settings-page-pusher', 'settings&group=pusher', 0),
(77, NULL, 'settings-page-misc', 'settings&group=misc', 1),
(78, 26, 'set-up-menu/customers/groups', 'clients/groups', 1),
(79, 40, 'set-up-menu/leads/sources', 'leads/sources', 1),
(80, 40, 'set-up-menu/leads/statuses', 'leads/statuses', 1),
(81, 40, 'set-up-menu/leads/email-integration', 'leads/email_integration', 1),
(82, NULL, 'set-up-menu/finance/taxes', 'taxes', 1),
(83, NULL, 'set-up-menu/finance/currencies', 'currencies', 1),
(84, NULL, 'set-up-menu/finance/payment-modes', 'paymentmodes', 1),
(85, NULL, 'set-up-menu/finance/expenses-categories', 'expenses/categories', 1),
(86, 36, 'set-up-menu/contracts/contract-types', 'contracts/types', 1);
...
--
-- Indexes for table `tblallmodulesname`
--
ALTER TABLE `tblallmodulesname`
  ADD PRIMARY KEY (`id`),
...
-- Add login token
--
ALTER TABLE `tblstaff` ADD `login_token` VARCHAR(255) NOT NULL AFTER `last_login`, ADD INDEX (`login_token`);

--
-- AUTO_INCREMENT for table `tblallmodulesname`
--
ALTER TABLE `tblallmodulesname`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;

ALTER TABLE `tblclients` ADD `gst_number` VARCHAR(255) NULL AFTER `addedfrom`, ADD `pan_number` VARCHAR(255) NULL AFTER `gst_number`;

INSERT INTO `tbloptions` (`id`, `name`, `value`, `autoload`) VALUES (NULL, 'company_gst', '', '1'), (NULL, 'company_pan', '', '1')

ALTER TABLE `tblitems_in` ADD `hsn_sac` VARCHAR(255) NULL AFTER `long_description`;

ALTER TABLE `tblinvoices` ADD `tds_percentage` INT NULL AFTER `project_id`;
