...
@section('content')
    <div id="msgDiv" class=" alert_cs alert alert-success alert-dismissible" style="display:none;">
         <img src="{{asset('new_admin/images/success.svg')}}" class="icon_svg"/>
          <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">x</span></button>
          <strong>Successfully Updated</strong>
    </div>
@if($add_button)
<a href="{{$add_button}}" class="btn btn-success add_button pull-right top_ps"><i class="material-icons">add_circle_outline</i>Add</a>
         ...
         <tr>
            ...
            <td>
               <div class="flex_button_">
                  ...
                  <a href="{{ url('/').'/'.ADMIN_PATH.'/support-ticket-management/all-support-tickets/edit-ticket/'.$support_ticket_data['id'] }}" class="waves-effect btn btn-warning"><i class="material-icons">create</i>Edit</a>
                  <a href="{{ url('/').'/'.ADMIN_PATH.'/support-ticket-management/all-support-tickets/delete/'.$support_ticket_data['id'] }}" class="waves-effect delete_button btn btn-danger"><i class="material-icons">delete_sweep</i>Delete</a>
               </div>
            </td>
         </tr>
         @endforeach
